const btnEncript = document.getElementById("button__encriptor");
const btnDesencrit = document.getElementById("button__desencrip");
const btnCopiar = document.getElementById("button__copiar");
...
btnDesencrit.addEventListener("click", function () {
  const enteredText = document.getElementById("input__text").value.trim();
